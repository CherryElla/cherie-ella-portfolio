...
export default function Blog() {
  return (
    <div class="pt-20">
      <div class=" projectsBox flex flex-wrap justify-center m-9 p-9 gap-20 text-orange-600 bg-slate-900">
            <a href="" target="_blank"class="group flex flex-col items-center text-center justify-center relative w-96 ">
                ...
                />
                <div class="absolute h-auto w-100 object-contain">Moonlander Keyboard</div>
            </a>
            <a href="" target="_blank" class="group flex flex-col items-center text-center justify-center relative w-96 ">
                <img
